"""
PDF Processing Tools - Refactored with async and provider abstraction
Extract and analyze research papers from PDF files.
"""
...
async def process_uploaded_pdf(pdf_path: str, provider: BaseLLMProvider) -> str:
    """
    ...
    Returns:
        Structured summary of the PDF content
    """
...
Provide a clear, structured summary in Arabic (MSA) or English, depending on what seems more appropriate."""
        ...
        response = await provider.generate_simple(prompt, temperature=0.3)
