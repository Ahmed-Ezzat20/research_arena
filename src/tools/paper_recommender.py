"""
Similar Paper Recommender Tool
...
class PaperRecommender:
    ...
    def get_recommendations_by_id(self, paper_id: str, id_type: str = "doi", limit: int = 10) -> List[Dict[str, Any]]:
        """
        ...
        try:
            ...
            recommendations = self.semantic_scholar.get_recommendations(paper_id_formatted, limit=limit)
    ...
    def get_recommendations_by_title(self, title: str, limit: int = 10) -> List[Dict[str, Any]]:
        """
        ...
        try:
            ...
            recommendations = self.semantic_scholar.get_recommendations(paper_id, limit=limit)
    ...
    def get_recommendations_by_content(self, paper_content: str, limit: int = 10) -> List[Dict[str, Any]]:
        """
...
"""
            ...
            similar_papers = self.semantic_scholar.search_paper(search_query, limit=limit)
...
def recommend_similar_papers(paper_info: str, num_recommendations: int = 10) -> str:
    """
    ...
    if not recommendations:
        ...
        if len(paper_info) < 200 and not '\n\n' in paper_info:
            ...
            recommendations = recommender.get_recommendations_by_title(paper_info, limit=num_recommendations)

    if not recommendations:
        # Fall back to content-based recommendations
        logger.info("📋 Using content-based similarity search")
        recommendations = recommender.get_recommendations_by_content(paper_info, limit=num_recommendations)
...
def quick_recommend(doi_or_arxiv: str, num_papers: int = 5) -> str:
    """
    ...
    return recommend_similar_papers(doi_or_arxiv, num_recommendations=num_papers)
