"""
Advanced Source Verification Tool - Main Orchestrator
...
def verify_document_sources(document_text: str, verify_claims: bool = True, verify_references: bool = True) -> str:
    """
    ...
    if verify_references:
        ...
        try:
            ref_results = validate_all_references(document_text)
    ...
    if verify_claims:
        ...
        try:
            claim_results = verify_all_claims(document_text)
...
def quick_verify_references(document_text: str) -> str:
    """
    ...
    return verify_document_sources(document_text, verify_claims=False, verify_references=True)


def quick_verify_claims(document_text: str) -> str:
    """
    ...
    return verify_document_sources(document_text, verify_claims=True, verify_references=False)
