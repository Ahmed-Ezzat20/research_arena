...
def create_app():
    ...
    with gr.Blocks(title="Research Arena - Agentic Research Assistant") as demo:
        # Header
        gr.Markdown(
            """
        # 🔬 Research Arena
        ...
        with gr.Tabs() as tabs:
            ...
            with gr.Tab("📋 Logs", id="logs_tab"):
                ...
                with gr.Row():
                    ...
                    with gr.Column(scale=1):
                        refresh_btn = gr.Button(
                            "🔄 Refresh Logs", variant="secondary", size="sm"
                        )
                ...
                **Log Levels:**
                ...
                # Event Handlers
                refresh_btn.click(fn=refresh_logs, outputs=[logs_display])

                clear_btn.click(fn=clear_logs, outputs=[logs_display])
